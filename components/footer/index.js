            ...
            <footer id="footer-area">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="footer-items">
                                <h4 className="footer-list-heading">CATEGORIES</h4>
                                <div className="footer-list-item">
                                    <ul>
                                ...
                                <div className="footer-list-item contacts">
                                    <ul>
                                        <li>
                                            ...
                                            Ahsan Ahmed Road, 32 Choto Mirzapur, Peace Palace, Khulna, 9100
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <i><AiOutlineMail/></i> <a
                                            href="mailto:foodjocky@gmail.com"> foodjocky@gmail.com
                                        </a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="footer-items">
                                <h4 className="footer-list-heading">KEEP IN TOUCH</h4>
                                        ...
                                        <div className="form-group">
                                            <div className="input-group">
                                                ...
                                                <div className="input-group-append">
                                                    <button type="button"
                                                            className="btn-submit-footer button-site-footer">
                                                        <FaPaperPlane/>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <ul>
                                            <li><a href="https://twitter.com/FoodJocky" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-735 237 28 28"
                                                    ...
                                                    <path fill="#55ACEE"
                                                          d="M-733 237h24c1.105 0 2 .895 2 2v24c0 1.105-.895 2-2 2h-24c-1.105 0-2-.895-2-2v-24c0-1.105.895-2 2-2z"/>
                                                    <path fill="#fff"
                                            ...
                                            <li><a href="https://www.facebook.com/Food-Jocky-108384861049664"
                                                   target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-735 237 28 28"
                                                     data-bubblesppbfhhgcdehhbjigifndnfmcihegokbbprevent-events-conflict-installed="true"
                                                     data-arp-injected="true">
                                            ...
                                            <li><a href="https://www.instagram.com/foodjocky/" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 180 612 612"
                                                     ...
                                                     data-bubblesppbfhhgcdehhbjigifndnfmcihegokbbprevent-events-conflict-installed="true"
                                                     data-arp-injected="true">
                                                    <radialGradient id="a" cx="130.802" cy="895.869" r="968.776"
                                                    ...
                                                    <path fill="url(#a)"
                                                          d="M43.7 180h524.6c24.2 0 43.7 19.6 43.7 43.7v524.6c0 24.2-19.6 43.7-43.7 43.7h-524.6c-24.1 0-43.7-19.6-43.7-43.7v-524.6c0-24.1 19.6-43.7 43.7-43.7z"/>
                                                    <g fill="#fff" stroke="#fff" strokeMiterlimit="10">
                                                        ...
                                                        <circle strokeWidth="9" cx="427.7" cy="364.3" r="25"/>
                                                    </g>
                                                </svg>
                                            </a></li>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                                <div className="payment-card-list">
                                    <ul>
                                        <li><img src='assets/img/payment-card/cash.png' ali="Cash"/></li>
                                        <li><img src='assets/img/payment-card/bkash-pay.png' alt="Bkash"/></li>
                                        <li><img src='assets/img/payment-card/rocate-pay.png' alt="Rocket"/></li>
                                        <li><img src='assets/img/payment-card/nogod.png' alt="nogod"/></li>
                                        <li><img src='assets/img/payment-card/visa.png' alt="Visa"/></li>
                                        <li><img src='assets/img/payment-card/master.png' alt="master"/></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-12 col-sm-12 col-12">
