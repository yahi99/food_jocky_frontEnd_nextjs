                ...
                <div className="container">
                                ...
                                <div className="search-filter-area">
                                    <div id="adv-search">
                                        <Input
                                            ...
                                            style={{
                                                boxShadow: '2px 0px 18px -3px #c8102e2b',
                                            }}
                                            prefix={
                                            ...
                                            suffix={(
                                                <div className="position-relative" ref={ref} style={{marginLeft: 10}}>
                                                    <button type="button"
                                                    ...
                                                    <div className="dropdown-menu-right search-shadow mt-3"
                                                         style={{display: open ? 'block' : 'none', zIndex: 9999999}}>
                    ...
                    <div className="restaurant-list-wrapper">
                        ...
                        {(!restaurants.loading && !restaurants.error) && (
                            <>
                                <Sliders title="Top" restaurants={restaurants.top} type={type}/>
                                <Sliders title="Newest" restaurants={restaurants.new} type={type}/>
                                <Sliders title="Nearest" restaurants={restaurants.nearest} type={type}/>

                                <div className="restaurant-wrapper-heading mb-4">
                                    <h2>
                                        {type === 'restaurant' ? `${search.length > 0 ? `${restaurants.all.length} Restaurants Found` : 'All Restaurants'}` : `${search.length > 0 ? `${restaurants.all.length} Homemade Found` : 'All Homemade'}`}
                                    </h2>
                                </div>
                                <div className="row">
...
const Sliders = ({title, restaurants, type}) => {
    ...
    return (
        <div className="restaurant-wrapper-heading mb-4">
            <h2 className="mb-1">
                {title} {type === 'restaurant' ? 'Restaurants' : 'Homemade'}
            </h2>
            <div>
                <Slider {...settings}>
