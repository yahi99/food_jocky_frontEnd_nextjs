            ...
            <div  className="top-area-restau-info">
              ...
              <div  className="area-modal-resta-name text-center">
                ...
                <div  className="opning-time-modal">
                  <ul>
                    <li><span>Open 8:00 AM</span> - <span>11:00 PM</span></li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div className="col-lg-6">
                  <div className="restaurant-list-modals-area-wrapper">
                    <div className="restaurant-modals-names-list">
                      <h4>About</h4>
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil autem aperiam molestiae officia
                        quod, dolore numquam deserunt eum explicabo assumenda distincti.</p>
                    </div>
        ...
        <div className="row" onClick={handleShow }>
          <div className="col-lg-8 col-md-10 col-sm-11 col-11">
            <div className="name-catagory-details-area">
              <href  data-toggle="modal" data-target="#restaurant-info-modal"/>
          ...
          <div className="col-lg-4 col-md-2 col-sm-1 col-1">
            <href  data-target="#restaurant-info-modal"/>
              <div className="info-area-modal">
                <i><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 0 512 512" fill="#c8102e"
                    width="20px" data-bubblesppbfhhgcdehhbjigifndnfmcihegokbbprevent-events-conflict-installed="true"
        ...
        <div className="container" >
          ...
          <div className="row">
         {
          food_category.foods.map(val=>{
            return  <MenuItem heading={val.name} person={val.description} currprice={val.price} oldprice={'200'} img={val.dish_img} />
          })
         }
          </div>
        </div>
