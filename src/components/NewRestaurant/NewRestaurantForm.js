          ...
          <div className="customer_entry_form">
             ...
             <form id="New_Res_Add">
                ...
                <div className="col-lg-6">
                  ...
                  <div className="col-lg-6">
                  <FormControl>
                  <InputLabel id="demo-simple-select-label" color="red" >Select Type</InputLabel>
                  <Select
                  ...
                  <div className="col-lg-6">
                  <FormControl>
                  <InputLabel id="demo-simple-select-label"   color="red" >Food Category</InputLabel>
                  <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
                  >
                  ...
                  <div className="col-lg-12">
                  <ChipInput label="Tags" id="tags_area"
                    defaultValue={[]}
                  ...
                  <div className="col-lg-6">
                  <MDBInput type="file" label="Select main image..." className="chose_file"/>
                  ...
                  <div className="col-lg-6">
                  <MDBInput type="file" label="Select thumb image..." className="chose_file"/>
                  <div className="area_img_Add">
                    <h6>Thumb Image</h6>
                    <img src="https://mdbootstrap.com/img/Photos/Others/images/89.jpg" alt="img" />
                  </div>
                  ...
                  <MuiPickersUtilsProvider utils={DateFnsUtils} >
                     <TimePicker value={selectedDate} onChange={handleDateChange} label="Start" />
                     </MuiPickersUtilsProvider>
                  </div>
                  <div className="col-lg-6" id="time_pickers">
                  <MuiPickersUtilsProvider utils={DateFnsUtils} >
                     <TimePicker value={selectedDate} onChange={handleDateChange}  label="End"/>
                     </MuiPickersUtilsProvider>
                  </div>
                </div>
